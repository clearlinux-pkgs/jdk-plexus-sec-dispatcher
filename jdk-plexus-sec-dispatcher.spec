...
#
Name     : jdk-plexus-sec-dispatcher
Version  : 9ea2038
Release  : 2
URL      : https://github.com/codehaus-plexus/plexus-sec-dispatcher/archive/9ea2038.tar.gz
Source0  : https://github.com/codehaus-plexus/plexus-sec-dispatcher/archive/9ea2038.tar.gz
Summary  : No detailed summary available
Group    : Development/Tools
License  : Apache-2.0
Requires: jdk-plexus-sec-dispatcher-data
...
BuildRequires : six
BuildRequires : xmvn
Patch1: plexus-sec-dispatcher-pom.patch

%description
No detailed description available

%package data
Summary: data components for the jdk-plexus-sec-dispatcher package.
Group: Data

%description data
data components for the jdk-plexus-sec-dispatcher package.


%prep
%setup -q -n plexus-sec-dispatcher-9ea2038069d4f1b5d9a6be82974f61289bf7382f
%patch1 -p1

python3 /usr/share/java-utils/mvn_file.py : plexus/plexus-sec-dispatcher

%build
python3 /usr/share/java-utils/mvn_build.py

%install
xmvn-install  -R .xmvn-reactor -n plexus-sec-dispatcher -d %{buildroot}
